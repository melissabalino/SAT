...
namespace SAT.UI.MVC.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            ViewData["ScheduledClassId"] = new SelectList(_context.ScheduledClasses, "ScheduledClassesId", "InstructorName");
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentId,StudentId,ScheduledClassId,EnrollmentDate")] Enrollment enrollment)
        {
            ...
            ViewData["ScheduledClassId"] = new SelectList(_context.ScheduledClasses, "ScheduledClassesId", "InstructorName", enrollment.ScheduledClassId);
